var personal_msg = {
    ...
    dataLoad: function () {
        ...
        fetch("http://192.168.3.118/Api/Index/ge", {
            ...
            if (data.code == 200) {
                ...
                $(".user-logo-img").attr("src", "http://192.168.3.118" + data.data.img);
        ...
        fetch("http://192.168.3.118/Api/Index/province", {
            method: 'POST',
            //headers: myHeaders,
            mode: 'cors',
            cache: 'default'
        ...
        fetch("http://192.168.3.118/Api/Index/city", {
            method: 'POST',
            //headers: myHeaders,
            mode: 'cors',
            cache: 'default'
    ...
    updataImg: function () {
        ...
        $("#user_logo_file").change(function () {
            ...
            var FileController = "http://192.168.3.118/Api/Index/img"; // 接收上传文件的后台地址
            // FormData 对象
            var form = new FormData();
    ...
    clickSaveBtn: function () {
        ...
        $(".save-btn").click(function (e) {
            ...
            fetch("http://192.168.3.118/Api/Index/useredit", {
                method: 'POST',
                //headers: myHeaders,
                mode: 'cors',
                cache: 'default',
