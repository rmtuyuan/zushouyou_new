...
var my_publish = {
    ...
    ge_msg: function () {
        ...
        fetch("http://192.168.3.118/Api/Index/ge", {
            method: 'POST',
            //headers: myHeaders,
            mode: 'cors',
            cache: 'default',
    ...
    dataLoad: function () {
        ...
        if (loginName) {
            ...
            //1 游戏类型
            fetch("http://192.168.3.118/Api/Index/shop_list", {
                method: 'POST',
                //headers: myHeaders,
                mode: 'cors',
                cache: 'default'
    ...
    dataLoadFun: function (form) {
        ...
        //2 游戏列表
        fetch("http://192.168.3.118/Api/Index/game_list", {
            method: 'POST',
            //headers: myHeaders,
            mode: 'cors',
            cache: 'default',
        ...
        //3 系统 写死了
        //4 大区
        fetch("http://192.168.3.118/Api/Index/game_large", {
            method: 'POST',
            //headers: myHeaders,
            mode: 'cors',
            cache: 'default',
        ...
        //5 服务器
        fetch("http://192.168.3.118/Api/Index/server", {
            method: 'POST',
            //headers: myHeaders,
            mode: 'cors',
            cache: 'default',
    ...
    wenDataLoad: function () {
        //温馨提示内容加载
        fetch("http://192.168.3.118/Api/index/wen", {
            method: 'POST',
            //headers: myHeaders,
            mode: 'cors',
            cache: 'default',
    ...
    authorization: function () {
        ...
        fetch("http://192.168.3.118/Api/Index/grant", {
            method: 'POST',
            //headers: myHeaders,
            mode: 'cors',
            cache: 'default',
    ...
    pubishModalSelect: function () {
        ...
        $(".other-modal-1>p>a").click(function (e) {
            ...
            if ($(this).hasClass("quit-publish")) {
                ...
                //确认发布  fetch
                fetch("http://192.168.3.118/Api/index/release_tong", {
                    method: 'POST',
                    //headers: myHeaders,
                    mode: 'cors',
                    cache: 'default',
