var rePublish = {
    ...
    dataLoad: function () {
        ...
        if (this.leaseid == 1) {
            //其他 
            fetch("http://192.168.3.118/Api/index/see_shelves", {
                method: 'POST',
                //headers: myHeaders,
                mode: 'cors',
                cache: 'default',
                ...
                if (data.code == 200) {
                    ...
                    for (var i = 0; i < rePublish.img_file.length; i++) {
                        ...
                        img_html += `<div class="img-con" data-item=${i} style="height:${rePublish.updataImgHt}">
                              <div><img src="http://192.168.3.118${element}" alt=""/></div>
            ...
            //审核中的
            fetch("http://192.168.3.118/Api/index/see_examine", {
                method: 'POST',
                //headers: myHeaders,
                mode: 'cors',
                cache: 'default',
        ...
        $(".other-modal-1>p>a").click(function (e) {
            ...
            if ($(this).hasClass("quit-publish")) {
                ...
                if (rePublish.leaseid == 2) {
                    //待审核
                    fetch("http://192.168.3.118/Api/index/uplede_to_examine", {
                        method: 'POST',
                        //headers: myHeaders,
                        mode: 'cors',
                        cache: 'default',
                    ...
                    //其他
                    fetch("http://192.168.3.118/Api/index/change_shelves", {
                        method: 'POST',
                        //headers: myHeaders,
                        mode: 'cors',
                        cache: 'default',
    ...
    updataImg: function () {
        ...
        $(".add-img-btn>input").change(function (e) {
            ...
            if (strExtension != 'jpg' && strExtension != 'gif' &&
                ...
                xhr.open("post", "http://192.168.3.118/Api/index/img", true);
    ...
    delPublish: function () {
        ...
        $(".reset-fabu-btn-box").on("click", ".close-del-2", function (e) {
            ...
            fetch("http://192.168.3.118/Api/index/delete_to_examine ", {
                method: 'POST',
                //headers: myHeaders,
                mode: 'cors',
                cache: 'default',
    ...
    closePublish:function () {  
        //关闭发布
          $(".reset-fabu-btn-box").on("click", ".close-del-1", function (e) {
            ...
            fetch("http://192.168.3.118/Api/index/close_publication", {
                method: 'POST',
                //headers: myHeaders,
                mode: 'cors',
                cache: 'default',
