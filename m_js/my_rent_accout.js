...
var AccountDetail = {
    ...
    init: function () {
        ...
        this.indexi = $.getUrlParam("indexi");
    ...
    ShowMsg: function () {
        ...
        fetch("http://192.168.3.118/Api/index/rent", {
            method: 'POST',
            //headers: myHeaders,
            mode: 'cors',
            cache: 'default',
            ...
            if (data.code == 200) {
                ...
                //banner 图片
                $('.banner-img-box').html(`  <img src="http://192.168.3.118${data.data.simg}" alt="" />`)
                var msg_html = '';
        ...
        if (this.type == 1) {
            ...
            fetch("http://192.168.3.118/Api/Index/order", {
                method: 'POST',
                //headers: myHeaders,
                mode: 'cors',
                cache: 'default',
               ...
               // console.log(data);
                if (data.code == 200) {
                    $(".time-money").html(`租用${data.data[AccountDetail.indexi].hour}  ${data.data[AccountDetail.indexi].waste}元`);
                    $(".done-time").hide();
                    $('.ing-time-diff').html(`  剩余时间 <span class='time-count' data-time='${data.data[AccountDetail.indexi].stoptime-data.data[AccountDetail.indexi].currenttime}' >2小时35分09秒</span>`);
                    AccountDetail.stopTime($('.time-count').data("time"), $('.time-count'));
                }
            });
        } else {
            //已完成
            fetch("http://192.168.3.118/Api/Index/completed", {
                method: 'POST',
                //headers: myHeaders,
                mode: 'cors',
                cache: 'default',
                ...
                if (data.code == 200) {
                      ...
                      $(".time-money").html(`租用${data.data[AccountDetail.indexi].hour}  ${data.data[AccountDetail.indexi].waste}元`);
                      $(".done-time").show().css('display',"flex");
                      $(".my-rent-account-fixed").hide();
                }
            });
        }
    },
    userEvaluate: function () {
        ...
        fetch("http://192.168.3.118/Api/index/evaluate", {
            method: 'POST',
            //headers: myHeaders,
            mode: 'cors',
            cache: 'default',
                                ...
                                <div class="content-2-item-rt">
                                    ...
                                    <div class="user-msg-box">
                                        <div class="content-2-item-lf">
                                            <div><img src="http://192.168.3.118${element.pic}" alt="" /></div>
                                        </div>
                                        <div>
    ...
    zuhaoDescription: function () {
        ...
        fetch("http://192.168.3.118/Api/index/hire", {
            method: 'POST',
            //headers: myHeaders,
            mode: 'cors',
            cache: 'default'
        ...
        $('.collect').click(function (e) {
            ...
            if (loginName) {
                if ($(this).hasClass("active")) {
                    ...
                    form.append("commodity_id", AccountDetail.sid); // 
                    fetch("http://192.168.3.118/Api/index/cancel_shou_cell", {
                        method: 'POST',
                        //headers: myHeaders,
                        mode: 'cors',
                        cache: 'default',
                    ...
                    form.append("uid", loginName); // 
                    form.append("commodity_id", AccountDetail.sid); // 
                    fetch("http://192.168.3.118/Api/index/cell", {
                        method: 'POST',
                        //headers: myHeaders,
                        mode: 'cors',
                        cache: 'default',
        ...
        $(".rent").click(function (e) {
            ...
            if (loginName) {
                ...
                if (AccountDetail.money_select) {
                    ...
                    fetch("http://192.168.3.118/Api/index/bind", {
                        method: 'POST',
                        //headers: myHeaders,
                        mode: 'cors',
                        cache: 'default',
                        ...
                        if (data.data == 1) {
                            ...
                            //保存接口
                            fetch("http://192.168.3.118/Api/index/immediately_pay", {
                                method: 'POST',
                                //headers: myHeaders,
                                mode: 'cors',
                                cache: 'default',
                                ...
                                if (data.code == 200) {
                                    //成功就跳转
                                    window.location.href = `http://192.168.3.120/zushouyou_new/pay.html?id=${AccountDetail.id}`;
                                }
                            });

                        } else {
                            window.location.href = "http://192.168.3.120/zushouyou_new/bind_phone.html";
                        }
    ...
    stopTime: function (diff, mark) {
        ...
        mark.html(` ${hour}时${minute}分${second}秒`);
