...
var gameList = {
    ...
    clickNext: function () {
        ...
        $(".ipt-box").on("click" , "a", function (e) {  
             e.preventDefault();
             window.location.href =`http://192.168.3.120/zushouyou_new/account_list.html?id=${ gameList.id}&system_id=${ gameList.system_id}&server_id=${ gameList.server_id}&game_large_id=${ gameList.game_large_id}&shop_id=${gameList.shop_id}`;
        } );
